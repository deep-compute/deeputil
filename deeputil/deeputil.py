...
class Dummy(object):
    ...
    <deeputil.deeputil.Dummy object at 0x...>
    ...
    (<deeputil.deeputil.Dummy object at 0x...>, '__init__', {'prefix': [], 'args': (1,), 'kwargs': {'a': 5}})
    >>> d.foo() #doctest: +ELLIPSIS
    (<deeputil.deeputil.Dummy object at 0x...>, '__getattr__', {'attr': 'foo'})
    (<deeputil.deeputil.Dummy object at 0x...>, '__init__', {'prefix': ['foo'], 'args': (), 'kwargs': {}})
    (<deeputil.deeputil.Dummy object at 0x...>, '__call__', {'prefix': ['foo'], 'args': (), 'kwargs': {}})
    >>> d.bar #doctest: +ELLIPSIS
    (<deeputil.deeputil.Dummy object at 0x...>, '__getattr__', {'attr': 'bar'})
    (<deeputil.deeputil.Dummy object at 0x...>, '__init__', {'prefix': ['bar'], 'args': (), 'kwargs': {}})
    <deeputil.deeputil.Dummy object at 0x...>
    >>> d.foo.bar() #doctest: +ELLIPSIS
    (<deeputil.deeputil.Dummy object at 0x...>, '__getattr__', {'attr': 'foo'})
    (<deeputil.deeputil.Dummy object at 0x...>, '__init__', {'prefix': ['foo'], 'args': (), 'kwargs': {}})
    (<deeputil.deeputil.Dummy object at 0x...>, '__getattr__', {'attr': 'bar'})
    (<deeputil.deeputil.Dummy object at 0x...>, '__init__', {'prefix': ['foo', 'bar'], 'args': (), 'kwargs': {}})
    (<deeputil.deeputil.Dummy object at 0x...>, '__call__', {'prefix': ['foo', 'bar'], 'args': (), 'kwargs': {}})
    '''
